...
export function Footer() {
    return (
        <footer className="relative py-20 px-4 sm:px-6 lg:px-8 border-t border-white/10">
            ...
            <div
                className="absolute top-0 left-1/4 w-96 h-96 rounded-full opacity-10 blur-3xl pointer-events-none transform-gpu"
                style={{
            ...
            >
              ...
              Roadmap
                ...
                <div
                    className="pt-10 mt-10 border-t border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
