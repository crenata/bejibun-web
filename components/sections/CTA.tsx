...
export function CTA() {
    return (
        <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div
                className="hidden md:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] z-0 pointer-events-none opacity-30 transform-gpu">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-xl md:text-2xl text-white/70 mb-10 max-w-3xl mx-auto">
                            Framework with Bun-native performance, ship APIs and Web3 apps with a fast & friendly
                        ...
                        {/* Quick start command */}
                        <div
                            className="bg-[#0A0A0F]/80 backdrop-blur-sm rounded-xl p-4 inline-block border border-white/10">
                            <code className="text-white/90 text-sm md:text-base font-mono">
                                <span className="text-[#6A5CFF]">$</span> <span
                                className="text-[#E056C1]">bunx</span> @bejibun/cli your-project
                            </code>
                        </div>
                        ...
                        >
                            <div>
                                <div
                                    className="text-3xl font-semibold mb-2 bg-gradient-to-r from-[#E056C1] to-[#6A5CFF] bg-clip-text text-transparent">
